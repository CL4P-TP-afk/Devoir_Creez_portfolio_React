        ...
        <>
            ...
            <div className="container text-center ">
                <div class="row justify-content-center my-5 ">
                    <div className="col-4 text-center border-bottom border-primary border-5 ">
                        <h1>Mon offre de services</h1>
                        <p className="pb-3">voici les prestations sur lesquelles je peux intervenir</p>
                    </div>
                </div>
            </div>
                <div class="row justify-content-center my-5 py-4">
                    <div class="col-md-3 ">
                        <div class="card h-100 text-center card-services">
                            <div class="card-body ">
                    ...
                    <div class="col-md-3">
                        <div class="card h-100 text-center">
                            ...
                            <path d="M11.742 10.344a6.5 6.5 0 1 0-1.397 1.398h-.001q.044.06.098.115l3.85 3.85a1 1 0 0 0 1.415-1.414l-3.85-3.85a1 1 0 0 0-.115-.1zM12 6.5a5.5 5.5 0 1 1-11 0 5.5 5.5 0 0 1 11 0"/>
                                ...
                                <p class="card-text">Le référencement naturel (SEO) est une technique qui consiste à optimiser un site web pour le faire remonter 
